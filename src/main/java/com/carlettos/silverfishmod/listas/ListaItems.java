...
public class ListaItems {
    ...
    static {
        ...
        COAL_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.COAL_SILVERFISH_EGG, 0x8c8c8c, 0x000000);
        DEEPSLATE_COAL_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DEEPSLATE_COAL_SILVERFISH_EGG, 0x3D3D43, 0x000000);
        COPPER_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.COPPER_SILVERFISH_EGG, 0x8c8c8c, 0xE77C56);
        DEEPSLATE_COPPER_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DEEPSLATE_COPPER_SILVERFISH_EGG, 0x3D3D43, 0xE77C56);
        LAPIS_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.LAPIS_SILVERFISH_EGG, 0x8c8c8c, 0x01C53A8);
        DEEPSLATE_LAPIS_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DEEPSLATE_LAPIS_SILVERFISH_EGG, 0x3D3D43, 0x01C53A8);
        IRON_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.IRON_SILVERFISH_EGG, 0x8c8c8c, 0xD8AF93);
        DEEPSLATE_IRON_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DEEPSLATE_IRON_SILVERFISH_EGG, 0x3D3D43, 0xD8AF93);
        GOLD_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.GOLD_SILVERFISH_EGG, 0x8c8c8c, 0xFAEA2E);
        DEEPSLATE_GOLD_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DEEPSLATE_GOLD_SILVERFISH_EGG, 0x3D3D43, 0xFAEA2E);
        NETHER_GOLD_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.NETHER_GOLD_SILVERFISH_EGG, 0xd511515, 0xFAEA2E);
        REDSTONE_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.REDSTONE_SILVERFISH_EGG, 0x8c8c8c, 0xAA0F01);
        DEEPSLATE_REDSTONE_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DEEPSLATE_REDSTONE_SILVERFISH_EGG, 0x3D3D43, 0xAA0F01);
        DIAMOND_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DIAMOND_SILVERFISH_EGG, 0x8c8c8c, 0x4AEDD9);
        DEEPSLATE_DIAMOND_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DEEPSLATE_DIAMOND_SILVERFISH_EGG, 0x3D3D43, 0x4AEDD9);
        EMERALD_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.EMERALD_SILVERFISH_EGG, 0x8c8c8c, 0x00AA2C);
        DEEPSLATE_EMERALD_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.DEEPSLATE_EMERALD_SILVERFISH_EGG, 0x3D3D43, 0x00AA2C);
        QUARTZ_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.QUARTZ_SILVERFISH_EGG, 0xd511515, 0xDDD4C6);
        NETHERITE_SILVERFISH_EGG_SPAWN_EGG = createEggSpawnEgg(ListaEntidades.NETHERITE_SILVERFISH_EGG, 0xd511515, 0x5D342C);
